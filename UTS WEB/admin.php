...
<body>
    ...
    <nav>
           ...
           <a href="index.php"><span style="color: red;">Admin</span></a>
    </nav>
    ...
    function hapusData() {
        ...
        document.getElementById("outputNamaBarang").innerHTML = "";
        document.getElementById("outputHargaBarang").innerHTML = "";
        document.getElementById("outputJumlahBarang").innerHTML = "";
